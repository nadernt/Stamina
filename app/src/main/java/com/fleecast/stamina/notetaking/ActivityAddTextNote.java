...
//            if(intent.hasExtra(Constants.EXTRA_EDIT_NOTE_AND_RECORD)) {
    ...
    /*Intent i = new Intent(ActivityAddAudioNote.this, NoteTakingRecyclerViewActivity.class);
    startActivity(i);*/
        ...
        Utility.showMessage("You have a recording under progress. Stop it and try again!","Note",this);
    }*/
    ...
    private void initVariables(){
        ...
        // Flashing title
        ColorDrawable[] color = {new ColorDrawable(Color.WHITE), new ColorDrawable(ContextCompat.getColor(this, R.color.air_force_blue))};
    ...
    /*private PendingIntent createPendingIntent() {
        ...
        Intent intent = new Intent(getBaseContext(), ActivityAddAudioNote.class);
...
Log.e("DBGGGGGG",toggleNoStopRecord + "");
...
//                        vib.vibrate(30);
        ...
        btnRecordsListPlayer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //startActivity(new Intent(ActivityAddAudioNote.this,ActivityRecordsPlayList.class));
                Intent intent = new Intent(ActivityAddTextNote.this,ActivityRecordsPlayList.class);
...
/*
            Utility.showMessage("", "", ActivityAddAudioNote.this);
*/
            AlertDialog.Builder adb = new AlertDialog.Builder(ActivityAddTextNote.this);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(Constants.INTENTFILTER_RECORD_SERVICE)) {
                    ...
                    if(msgRecordService == Constants.REPORT_RECORD_ERROR_TO_ACTIVITY) {
                        Utility.showMessage("Hey you are too much fast don't rush at least hold on one second! ", "Ohhh", ActivityAddTextNote.this);
                    }
