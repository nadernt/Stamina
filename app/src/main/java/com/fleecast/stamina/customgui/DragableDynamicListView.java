 ...
 */
public class DragableDynamicListView extends ListView {

    private final int SMOOTH_SCROLL_AMOUNT_AT_EDGE = 15;
    private final int MOVE_DURATION = 150;
    private final int LINE_THICKNESS = 8;

    public ArrayList<CheesesSortingStruct> mCheeseList;
    ...
    public DragableDynamicListView(Context context) {
        super(context);
        init(context);
    }

    public DragableDynamicListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public DragableDynamicListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public void setCheeseList(ArrayList<CheesesSortingStruct> cheeseList) {
